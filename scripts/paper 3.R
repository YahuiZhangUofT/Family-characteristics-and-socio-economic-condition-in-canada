#### Preamble ####
# Purpose: The purpose of this code is to clean-up the 2017 GSS data obtained from the U of T library. 

# Thanks to the original contributors: Dr.Rohan Alexander and Dr.Sam Caetano
...
raw_data <- read_csv("AAC6IpmG.csv")
...
#change formatting for easy graph plotting

gss[gss == 'Less than $25,000']<- '$24,999 and less'
gss[gss == '$100,000 to $ 124,999']<- 'Between $100,000 and $124,999'
gss[gss == '$125,000 and more']<- 'More than $125,000'

#save cleaned data
write_csv(gss, "gss_family_2017.csv")
